...
public class MidtransConfig {
    ...
    public MidtransConfig(MidtransConfigProperties properties) {
        this.config = new Config(properties.getServerKey(), properties.getClientKey(), properties.isProduction());
    }
}
